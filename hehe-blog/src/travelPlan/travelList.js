...
import { Table, Button, message, Upload, Modal, Icon } from "antd";
          ...
          return (
            <Upload
              ...
              onRemove={file => {
                ...
                axios
                  .delete(`/api/viewPoint/photo/${record._id}`, {
  ...
  render() {
    return (
      <div>
        ...
        >
          <Upload
            action={`/api/viewPoint/photo/upload?id=${this.state.uploadModalId}`}
            multiple
          >
            <Button>
